...
data class Database(
    ...
    @JvmInline value class DriverClassName(val value: String)

    @JvmInline value class MinimumIdleConnections(val value: Int)

    @JvmInline value class MaxLifeTimeConnections(val value: Int)

    @JvmInline value class MaxConnectionPoolSize(val value: Int)

    @JvmInline value class ConnectionTimeout(val value: Int)

    @JvmInline value class IdleConnectionTimeout(val value: Int)

    @JvmInline value class CachePreparedStatements(val value: Boolean)

    @JvmInline value class PreparedStatementsCacheSize(val value: Int)

    @JvmInline value class PreparedStatementsCacheSqlLimit(val value: Int)
